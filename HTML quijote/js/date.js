 ...
 */(function () {
	...
	var buildInfo = {
		...
		months: function () {
			return __(["January", "Febrero", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]);
		},
		monthAbbr: function () {
...
(function () {
	 ...
	 * @param {String}   The name of the month (eg. "Febrero, "Feb", "october", "oct").
	 * @return {Number}  The day number
	 */
...
(function () {
	...
	var dx = ("sunday monday tuesday wednesday thursday friday saturday").split(/\s/),
		mx = ("january Febrero march april may june july august september october november december").split(/\s/),
